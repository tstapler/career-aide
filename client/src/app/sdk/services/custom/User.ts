...
export class UserApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public findByIdResumes(id: any, fk: any): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
      "/users/:id/resumes/:fk";
    let _routeParams: any = {
   ...
   * This method returns no data.
   */
  public destroyByIdResumes(id: any, fk: any): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
      "/users/:id/resumes/:fk";
    let _routeParams: any = {
   ...
   * </em>
   */
  public updateByIdResumes(id: any, fk: any, data: any = {}): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
      "/users/:id/resumes/:fk";
    let _routeParams: any = {
   ...
   * </em>
   */
  public getResumes(id: any, filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
      "/users/:id/resumes";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createResumes(id: any, data: any = {}): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
      "/users/:id/resumes";
    let _routeParams: any = {
   ...
   * This method returns no data.
   */
  public deleteResumes(id: any): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
      "/users/:id/resumes";
    let _routeParams: any = {
   ...
   *  - `count` – `{number}` - 
   */
  public countResumes(id: any, where: any = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public createManyResumes(id: any, data: any[] = []): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
      "/users/:id/resumes";
    let _routeParams: any = {
