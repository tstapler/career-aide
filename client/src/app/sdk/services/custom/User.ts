...
export class UserApi extends BaseLoopBackApi {
  ...
  /**
   * Find a related item by id for resumes.
   *
   * @param {any} id user id
   *
   * @param {any} fk Foreign key for resumes
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdResumes(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/resumes/:fk";
    let _routeParams: any = {
  ...
  /**
   * Delete a related item by id for resumes.
   *
   * @param {any} id user id
   *
   * @param {any} fk Foreign key for resumes
   ...
   * This method returns no data.
   */
  public destroyByIdResumes(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/resumes/:fk";
    let _routeParams: any = {
  ...
  /**
   * Update a related item by id for resumes.
   *
   * @param {any} id user id
   *
   * @param {any} fk Foreign key for resumes
   ...
   * </em>
   */
  public updateByIdResumes(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/resumes/:fk";
    let _routeParams: any = {
   ...
   * </em>
   */
  public getResumes(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/resumes";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createResumes(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/resumes";
    let _routeParams: any = {
   ...
   * This method returns no data.
   */
  public deleteResumes(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/resumes";
    let _routeParams: any = {
   ...
   *  - `count` – `{number}` - 
   */
  public countResumes(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/resumes/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createManyResumes(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/resumes";
    let _routeParams: any = {
